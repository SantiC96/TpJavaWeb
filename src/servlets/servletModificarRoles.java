...
/**
 * Servlet implementation class servletModificarRoles
 */
@WebServlet("/servletModificarRoles")
public class servletModificarRoles extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public servletModificarRoles() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dr.update(r.getIdRol(), r);
		request.setAttribute("IdRolIn", r);
