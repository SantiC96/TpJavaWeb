...
<body>
<form action="/TpJava/servletModificarCategorias" method="post">
		<input type="hidden" name="IdCatIn" value="<%=ct.getIdCategoria()%>" />
		<input type="hidden" name="descIn" value="<%=ct.getDescripcion()%>" />
