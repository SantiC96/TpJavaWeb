...
<body>
	<h1 align="center">Modificación de una Categoria</h1>
	<div class="container" align="left">
		<div class="row align-items-start">
			...
			<tr><td align="center"><font face="arial" size="5">ID Categoria</font></td>		<td align="center"><font face="arial" size="5"><%=request.getParameter("IdCatIn") %></font></td></tr>
		...
		<td>
		<div class="col" >
	<form action="modificarVerificacionCat.jsp" method="post">
		<table class="table table-hover table-striped table-sm border-secondary border border-5 rounded-3 bg-light table-bordered">
			...
			<tr><td align="center"><button type="reset" style="width:170px; height:35px">Limpiar</button></td>	<td align="center"><button value="<%=request.getParameter("IdCatIn") %>" name="IdCatIn" type="submit" style="width: 170px; height: 35px">Enviar</button></td></tr>
		</table>
	</form>
	</div>
	</div>
