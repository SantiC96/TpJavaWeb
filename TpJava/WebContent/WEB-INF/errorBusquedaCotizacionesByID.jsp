...
<title>Busqueda de cotizaciones por ID</title>
...
<h2 align="center"><font face="arial" color="red">El ID ingresado no pertenece a una cotización realizada.</font></h2>
...
<div class="container" align="left">
	<div class="row align-items-start">
		<div class="col col-md-10">
			<form action="servletCotizacionesByID" method="post">
				<table class="table table-hover table-striped table-sm border-secondary border border-5 rounded-3 bg-light">
					<tr><td align="center"><font face="arial" size="5">ID</font></td>	<td align="center"><input type="text" name="IdCot" size="30"></td></tr>
