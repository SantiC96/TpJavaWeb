...
<h1 align="center">¿Desea eliminar la siguiente provincia?</h1>
</head>
<body>
<form action="/TpJava/servletEliminarProvincias" method="post" >
	<div class="container" align="left">
		<div class="row align-items-start">
			<table class="table table-hover table-striped table-sm border-secondary border border-5 rounded-3 bg-light table-bordered" >
				...
				<tr><td align="center"><font face="arial" size="5">ID Provincia</font></td>		<td align="center"><font face="arial" size="5"><font face="arial" size="5"><%=request.getParameter("IdProvIn") %></font></td></tr>
