...
<h2 align="center"><font face="arial" color="red">Complete todos los campos correctamente para agregar una nueva persona.</font></h2>
<h1 align="center">Agregar a una persona nueva</h1>
	...
	<div class="container" align="left">
		<div class="row g-4" >
			<div class="col col-md-10">
				<form action="/TpJava/servletAgregarPersonas" method="post">
					<table class="table table-hover table-striped table-sm border-secondary border border-5 rounded-3 bg-light table-bordered">
						<tr><td align="center"><font face="arial" size="5">DNI</font></td>	<td align="center"><input type="number" name="dniIn" size="30"></td></tr>
