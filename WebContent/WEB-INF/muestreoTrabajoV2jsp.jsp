...
<body>
<h1 align="center">Listado de Trabajos</h1>
	<fieldset>
        		...
        		<div class="table-responsive">
            		<table class="table table-hover table-striped table-sm border-secondary border border-5 rounded-3 bg-light">	
					  <thead  class="table-dark">
						...
						<th colspan="2" ><a href="ABMCTrabajos/Agregar/agregarTrabajos.html"><button type="button" class="btn btn-light border border-dark"  style="width:210px; height:35px">Agregar</button></a></th>
	                </tr>
                </thead>
                <tbody>
                	<% 
					...
					<tr>
						...
						<form action="ABMCTrabajos/Modificacion/modificarTrabajos.jsp" method="get" >
								...
								<input type="hidden" name="tituloIn" value="<%=tra.getTitulo()%>" />
								<input type="hidden" name="descripcionIn" value="<%=tra.getDescripcion()%>" />
							...
							<td><button  value="<%=tra.getIdTrabajo() %>" name="IdTrabIn" type="submit" class="btn btn-light border border-dark"  style="width:100px; height:35px">Editar</button></td>
						</form>
						...
						<form action="ABMCTrabajos/Eliminar/eliminarTrabajos.jsp" method="get" >
								...
								<input type="hidden" name="obsIn" value="<%=tra.getObservaciones()%>" />
								<input type="hidden" name="idLocIn" value="<%=tra.getIdLocalidad()%>" />
							<td><button  value="<%=tra.getIdTrabajo() %>" name="IdTrabIn" type="submit" class="btn btn-light border border-dark"  style="width:100px; height:35px">Borrar</button></td>
						</form>
	                </tr>
	                <% } %>
	             </tbody>
