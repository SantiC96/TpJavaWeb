...
<h1 align="center">¿Desea eliminar el siguiente rol?</h1>
</head>
<body>
<form action="/TpJava/servletEliminarRoles" method="post" >
	<div class="container" align="left">
		<div class="row align-items-start">
			<table class="table table-hover table-striped table-sm border-secondary border border-5 rounded-3 bg-light table-bordered" >
				...
				<tr><td align="center"><font face="arial" size="5">ID Rol</font></td>		<td align="center"><font face="arial" size="5"><font face="arial" size="5"><%=request.getParameter("IdRolIn") %></font></td></tr>
