...
<form action="/TpJava/servletEliminarTrabajos" method="post" >
	<input type="hidden" name="userDni" value='<%=request.getParameter("userDni") %>' />
	<input type="hidden" name="userRol" value='<%=request.getParameter("userRol") %>' />
	<div class="container" align="left">
		<div class="row align-items-start">
			<table class="table table-hover table-striped table-sm border-secondary border border-5 rounded-3 bg-light table-bordered" >
				...
				<tr><td align="center"><font face="arial" size="5">Título</font></td>					<td align="center"><font face="arial" size="5"><label size="30"><%=request.getParameter("tituloIn") %></label></font> </td></tr>
				<tr><td align="center"><font face="arial" size="5">Descripción</font></td>				<td align="center"><font face="arial" size="5"><label size="30"><%=request.getParameter("descripcionIn") %></label></font> </td></tr>
		...
		<div class="row">
			<div class="col">
				<button value="<%=request.getParameter("IdTrabIn") %>" name="IdTrabIn" type="submit" class="btn btn-light border border-dark" style="width:170px; height:35px">Aceptar</button>
			</div>
</form>
			<div class="col">	
