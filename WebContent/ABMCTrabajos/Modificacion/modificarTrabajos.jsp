...
<body>
	...
	<div class="container" align="left">
		<div class="row align-items-start">
			...
			<tr><td align="center"><font face="arial" size="5">Titulo</font></td>					<td align="center"><font face="arial" size="5"><label size="30"><%=request.getParameter("tituloIn") %></label></font> </td></tr>
			<tr><td align="center"><font face="arial" size="5">Descripcion</font></td>				<td align="center"><font face="arial" size="5"><label size="30"><%=request.getParameter("descripcionIn") %></label></font> </td></tr>
	...
	<form action="modificarVerificacionTrab.jsp" method="post">
		<table class="table table-hover table-striped table-sm border-secondary border border-5 rounded-3 bg-light table-bordered">
			...
			<tr><td align="center"><font face="arial" size="5">ID Trabajo</font></td>				<td align="center"><font face="arial" size="5"><%=request.getParameter("IdTrabIn") %></font></td></tr>
			<tr><td align="center"><font face="arial" size="5">Titulo</font></td>					<td align="center"><input type="text" name="tituloIn" size="30"></td></tr>
			<tr><td align="center"><font face="arial" size="5">Descripcion</font></td>				<td align="center"><input type="text" name="descripcionIn" size="30"></td></tr>
			...
			<tr><td align="center"><button type="reset" class="btn btn-light border border-dark" style="width:170px; height:35px">Limpiar</button></td>	<td align="center"><button value="<%=request.getParameter("IdTrabIn") %>" name="IdTrabIn" type="submit" class="btn btn-light border border-dark" style="width: 170px; height: 35px">Enviar</button></td></tr>
		</table>
	</form>
