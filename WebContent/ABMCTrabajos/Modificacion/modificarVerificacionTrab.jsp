...
<form action="/TpJava/servletModificarTrabajos" method="post">
		...
		<div class="container" align="left">
			...
			<tr><td align="center"><font face="arial" size="5">Titulo</font></td>					<td align="center"><font face="arial" size="5"><%=request.getParameter("tituloIn") %></font> </td></tr>
			<tr><td align="center"><font face="arial" size="5">Descripcion</font></td>				<td align="center"><font face="arial" size="5"><%=request.getParameter("descripcionIn") %></font> </td></tr>
