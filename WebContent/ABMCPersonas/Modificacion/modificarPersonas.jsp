			...
			<div class="row align-items-start"> 
				...
				<form action="modificarVerificacionPers.jsp" method="post">
					...
					<table class="table table-hover table-striped table-sm border-secondary border border-5 rounded-3 bg-light table-bordered"> 
						...
						<tr><td align="center"><button type="reset" class="btn btn-light border border-dark" style="width:170px; height:35px">Limpiar</button></td> <td align="center"><button value="<%=request.getParameter("DNIin") %>" name="DNIin" type="submit" class="btn btn-light border border-dark" style="width: 170px; height: 35px">Enviar</button></td></tr> 
					</table> 
				</form> 
				</div> 
			</div> 
